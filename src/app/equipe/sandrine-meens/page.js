      ...
      <div className={styles.profilContent}>
        ...
        <h1 className={`${styles.profilTitle} sofia-pro-semibold text-uppercase`} style={{fontSize: '2.8rem', marginBottom: '1rem'}}>
          ...
          <div className={styles.presentation}>
            Initialement destinée à une carrière dans l’Éducation nationale, Sandrine fait le choix de se former à l’assistanat de direction. Elle occupe plusieurs postes dans différents secteurs d’activité comme le conseil en Ressources humaines ou les services bancaires, puis accepte une mission d’Office Manager lorsqu’une opportunité se présente. Elle y reste 10 années et y découvre un rôle central et pluridisciplinaire, au cœur de l’entreprise. Elle apprécie cette gestion simultanée de différentes fonctions de support aux équipes. Elle intègre ensuite Ofilae comme Office Manager, où elle est une aide précieuse, y compris dans le cadre de missions sortant de son périmètre habituel, et également en tant que Responsable du Secrétariat Privé. L’arrivée d’Evéna lui permet de se concentrer exclusivement sur cette activité, accompagnant les familles dans la gestion administrative de leur quotidien et de celle de leurs entreprises. Lorsqu’elle n’est pas au bureau, Sandrine aime prendre sa moto et découvrir de nouvelles balades. Elle aime aussi le tricot, y voyant l’occasion de créer de zéro quelque chose d’utile et de concret.
          </div>
        </div>
      </div>
    </div>
